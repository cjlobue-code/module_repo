...
# ── Credentials ──────────────────────────────────────────────────────────────
# The API key is never stored in this file or in the GitHub repo.
#   Streamlit Cloud -> App settings -> Secrets
#   Your own laptop -> falls back to local config.json (never uploaded)
def load_credentials():
    try:
        return st.secrets["OPENAI_API_KEY"], st.secrets["OPENAI_API_BASE"]
    except Exception:
        pass
